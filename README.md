...
Backend API for the Serenityline project.

## Frontend

The frontend web application for Serenityline is available
at [serenityline-web](https://github.com/Samuel-Valentini/serenityline-web).
